...
const AdminAuth = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // NOTE: The admin_id is required in the type definition but should be generated by a trigger
      // We need to explicitly include it with a placeholder to satisfy TypeScript
